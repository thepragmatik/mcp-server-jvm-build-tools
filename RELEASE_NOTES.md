...
v0.2.0 is a major expansion of the MCP Server for JVM Build Tools. This release grows from 7 tools to 24 MCP tools, adds SBT support alongside Maven and Gradle, introduces HTTP transport with SSE, delivers build performance profiling and dependency conflict detection, and upgrades the foundation to Spring Boot 3.5.14, Spring AI 2.0.0-RC2, and Java 21.

**43 commits** since v0.1.0. **307 tests** across the full surface.
